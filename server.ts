...
// AI Study Assistant (AI साथी) endpoint for unlimited queries
app.post("/api/ai-assistant", async (req, res) => {
  try {
    ...
    if (ai) {
      try {
        const systemInstruction = `तपाईं "Banking Tayari Nepal AI साथी" हुनुहुन्छ - नेपाल राष्ट्र बैंक (NRB), राष्ट्रिय वाणिज्य बैंक (RBB), कृषि विकास बैंक (ADBL), नेपाल बैंक लिमिटेड (NBL) तथा लोकसेवा आयोगका परीक्षार्थीहरूको लागि विशेष नेपाली भाषाको उच्चस्तरीय AI शिक्षक।
प्रयोगकर्ताले बैंकिङ, कानुन (नेपाल राष्ट्र बैंक ऐन २०५८, बैंक तथा वित्तीय संस्था सम्बन्धी ऐन बाफिया २०७३, सम्पत्ति शुद्धीकरण निवारण ऐन), व्यवस्थापन (HRM, Leadership, Planning), अर्थशास्त्र (मुद्रास्फीति, मौद्रिक नीति, वित्तीय नीति, GDP), लेखा (BRS, Audit, Balance Sheet), वा सामान्य ज्ञान/समसामयिक विषयमा कुनै पनि प्रश्न सोध्न सक्नेछन्।
...
सधैं शुद्ध, प्राज्ञिक र उच्च अंक ल्याउने परीक्षा-उपयोगी नेपाली भाषामा मात्र उत्तर दिनुहोस्।`;

        const prompt = `कृपया निम्न प्रश्न वा विषयको विस्तृत, परीक्षा उपयोगी र बुँदागत नेपालीमा उत्तर दिनुहोस्:\n"${cleanQuery}"`;
    ...
    if (q.includes("nrb") || q.includes("नेपाल राष्ट्र बैंक ऐन") || q.includes("२०५८") || q.includes("केन्द्रीय बैंक")) {
      fallbackText = `**नेपाल राष्ट्र बैंक ऐन, २०५८ सम्बन्धी परीक्षा तयारी टिपोट:**\n\n` +
      ...
      fallbackText = `**बैंक तथा वित्तीय संस्था सम्बन्धी ऐन (BAFIA), २०७३ सम्बन्धी परीक्षा उपयोगी बुँदाहरू:**\n\n` +
      ...
      fallbackText = `**सम्पत्ति शुद्धीकरण (निवारण) ऐन, २०६४ र AML/CFT का मुख्य व्यवस्थाहरू:**\n\n` +
      ...
      fallbackText = `**नेपालको मौद्रिक नीति र यसका प्रमुख उपकरणहरू:**\n\n` +
      ...
      fallbackText = `**व्यवस्थापन सिद्धान्त तथा सार्वजनिक प्रशासन (Management & Governance):**\n\n` +
      ...
      fallbackText = `**अर्थशास्त्र तथा नेपाली अर्थतन्त्र सम्बन्धी परीक्षा विशेष बुँदाहरू:**\n\n` +
      ...
      fallbackText = `**"${cleanQuery}" सम्बन्धी बैंकिङ तथा लोकसेवा विशेष परीक्षा तयारी सामग्री:**\n\n` +
